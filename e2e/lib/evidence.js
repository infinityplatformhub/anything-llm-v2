...
const toolCalledAny = (chunk, names) => names.some((name) => toolCalled(chunk, name));
...
module.exports = { mark, since, attached, toolCalled, toolCalledAny, attachedAny, files, pgCount, mysqlCount, mssqlCount };
